...
```
#Codebuch -> Link zum Codebuch zusätzlich in Github- https://github.com/js440/Testat_js440/blob/main/Testat_js440%20-%20Codebuch.csv

**Edge-Attribute** \

from: \ von welchem Verein und Land kommt der Spieler 
